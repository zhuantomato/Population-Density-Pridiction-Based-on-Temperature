...
LastEditTime: 2023-03-16 16:34:50
...
#     return road_data      
    if not os.path.exists('Outputs\Beijing'+str(i)+'.csv'):
            road_data.to_csv('Outputs\Beijing'+str(i)+'.csv',encoding='gbk',mode='a',index=False,index_label=False)      
    else:
            road_data.to_csv('Outputs\Beijing'+str(i)+'.csv', encoding='gbk', mode='a', index=False, index_label=False,header=False)
...
while True:
    if __name__ == '__main__':
        ...
        # 定义5个bounds
        bounds1 = "39.914614,116.446179;39.924614,116.456179"
        bounds2 = "39.987258,116.479573;39.997258,116.489573"
        bounds3 = "39.875608,116.461821;39.885608,116.471821"
