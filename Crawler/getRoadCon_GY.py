...
LastEditTime: 2023-03-25 12:41:00
...
#     return road_data      
    if not os.path.exists('Outputs\Guiyang'+str(i)+'.csv'):
            road_data.to_csv('Outputs\Guiyang'+str(i)+'.csv',encoding='gbk',mode='a',index=False,index_label=False)      
    else:
            road_data.to_csv('Outputs\Guiyang'+str(i)+'.csv', encoding='gbk', mode='a', index=False, index_label=False,header=False)
...
while True:
    if __name__ == '__main__':
        ...
        # 定义5个bounds
        bounds1 = "26.58033,106.715074;26.59033,106.725074"
        # bounds2 = "26.581553,106.702252;26.591553,106.712252"
        # bounds3 = "26.595023,106.706234;26.605023,106.716234"
